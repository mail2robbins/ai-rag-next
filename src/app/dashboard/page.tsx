    ...
    <div className="space-y-8">
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white dark:bg-gray-800 shadow-xl rounded-lg p-6 bg-gradient-to-b from-blue-100 via-teal-100 to-indigo-100 dark:bg-gradient-to-b dark:from-gray-800 dark:via-gray-700 dark:to-gray-800">
            <ChatInterface />
          </div>
        </div>
      </motion.div>
